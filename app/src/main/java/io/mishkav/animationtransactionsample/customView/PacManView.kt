package io.mishkav.coordinatorlayoutsample.customView
...
import io.mishkav.animationtransactionsample.R

class PacManView : View {
    private var ghostColor: Int = Color.YELLOW
    private var pacmanColor: Int = Color.RED
